...
- Carnot Cycle (Thermodynamics)
  Visualizes the PV diagram and explains heat engine efficiency.

- Wheatstone Bridge (Electric Circuits)
  Simulates resistance balancing and null detection.

- PN Junction Diode (Semiconductors)
  A fully interactive I–V characteristic simulator with forward and reverse bias behavior.
...
1. simply open this url: [Masterlab!!!](https://birbh.github.io/Physics-Masterlab)
